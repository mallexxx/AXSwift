...
public enum AXSubrole: String {
  ...
  case oncrementArrow       = "AXIncrementArrow"
...
public enum AXOrientation: Int {
   case unknown    = 0
   case vertical   = 1
   case horizontal = 2
}

public enum AXAttribute: String {
  // Standard attributes
  ...
  case lineForIndex              = "AXLineForIndex" //(NSNumber *) - line# for char index; param:(NSNumber *)
  case rangeForLine              = "AXRangeForLine" //(NSValue *)  - (rangeValue) range of line; param:(NSNumber *)
  case stringForRange            = "AXStringForRange" //(NSString *) - substring; param:(NSValue * - rangeValue)
  case rangeForPosition          = "AXRangeForPosition" //(NSValue *)  - (rangeValue) composed char range; param:(NSValue * - pointValue)
  case rangeForIndex             = "AXRangeForIndex" //(NSValue *)  - (rangeValue) composed char range; param:(NSNumber *)
  case boundsForRange            = "AXBoundsForRange" //(NSValue *)  - (rectValue) bounds of text; param:(NSValue * - rangeValue)
  case rtfForRange               = "AXRTFForRange" //(NSData *)   - rtf for text; param:(NSValue * - rangeValue)
  case styleRangeForIndex        = "AXStyleRangeForIndex" //(NSValue *)  - (rangeValue) extent of style run; param:(NSNumber *)
  case attributedStringForRange  = "AXAttributedStringForRange" //(NSAttributedString *) - does _not_ use attributes from Appkit/AttributedString.h
  ...
  case layoutPointForScreenPoint = "AXLayoutPointForScreenPoint" //(NSValue *)  - (pointValue); param:(NSValue * - pointValue)
  case layoutSizeForScreenSize   = "AXLayoutSizeForScreenSize" //(NSValue *)  - (sizeValue); param:(NSValue * - sizeValue)
  case screenPointForLayoutPoint = "AXScreenPointForLayoutPoint" //(NSValue *)  - (pointValue); param:(NSValue * - pointValue)
  case screenSizeForLayoutSize   = "AXScreenSizeForLayoutSize" //(NSValue *)  - (sizeValue); param:(NSValue * - sizeValue)
